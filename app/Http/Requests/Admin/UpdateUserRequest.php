...
class UpdateUserRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'national_code' => ['required', 'numeric', 'digits_between:5,100', new IrNationalCode, Rule::unique(User::class)->ignore($user)],
            ...
            'username' => ['required', 'string', 'alpha_num:ascii', 'min:2', 'max:100', new DontStartWithNumbers, Rule::unique(User::class)->ignore($user)],
